...
import { matchPrograms } from "@/lib/eligibility/programs";
...
export async function POST(req: NextRequest) {
  ...
  // Deterministic system matching of the signed facts against every program.
  const matches = matchPrograms(a);
  ...
  return NextResponse.json({ ok: true, ...bundle, matches, preview, publicKeys });
}
